...
REM 列出并使用.NET版本
C:\Users\Administrator\.dnx\bin\dnvm install 1.0.0-rc1-update1 -arch x64
C:\Users\Administrator\.dnx\bin\dnvm list
C:\Users\Administrator\.dnx\bin\dnvm use 1.0.0-rc1-update1 -arch x64
whoami
path
